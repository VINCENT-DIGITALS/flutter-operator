...
class ReportDownloadDialog extends StatefulWidget {
  @override
  _ReportDownloadDialogState createState() => _ReportDownloadDialogState();
}
  ...
  Future<void> _downloadData() async {
    ...
    if (result == 'success') {
      await _showResultDialog('Download Successful',
          'The Citizens Reports data has been downloaded successfully.');
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ListTile(
            title: Text('Download All Report records'),
            leading: Radio<bool>(
              value: false,
