...
class ResponderProfileDialog extends StatefulWidget {
  final String userId;

  ResponderProfileDialog({required this.userId});

  @override
  _ResponderProfileDialogState createState() => _ResponderProfileDialogState();
}

class _ResponderProfileDialogState extends State<ResponderProfileDialog> {
