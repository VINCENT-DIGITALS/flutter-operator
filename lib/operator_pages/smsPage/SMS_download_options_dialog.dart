...
class SMSDownloadDialog extends StatefulWidget {
  @override
  _SMSDownloadDialogState createState() => _SMSDownloadDialogState();
}

class _SMSDownloadDialogState extends State<SMSDownloadDialog> {
  ...
  Future<void> _downloadData() async {
    ...
    if (result == 'success') {
      await _showResultDialog('Download Successful',
          'The SMS data has been downloaded successfully.');
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ListTile(
            title: Text('Download All SMS records'),
            subtitle: Text(''),
            leading: Radio<bool>(
              value: false,
