import 'package:administrator/operator_pages/announcements/announcementUpdate.dart';
...
import '../../Models/archived_announcement_deletion_handler.dart';
import '../announcement_page.dart';
import 'announcementDialog.dart';

class ArchivedAnnouncementManagement extends StatefulWidget {
  const ArchivedAnnouncementManagement({super.key});

  @override
  _ArchivedAnnouncementManagementState createState() =>
      _ArchivedAnnouncementManagementState();
}

class _ArchivedAnnouncementManagementState
    extends State<ArchivedAnnouncementManagement> {
  ...
  void initState() {
    super.initState();
    announcementStream = _dbService.fetchArchivedAnnouncementData();
      ...
      builder: (context, constraints) {
        ...
        return Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            title: 'Archived Announcement Management',
          ),
                            ...
                            onPressed: () async {
                              ...
                              if (confirmDelete) {
                                try {
                                  ...
                                  await ArchivedAnnouncementDeletionHelper
                      ...
                      PopupMenuButton<String>(
                        onSelected: (String result) async {
                          if (result == 'Update') {
                            ...
                            bool confirmed =
                                await showConfirmationDialog('UnArchive');
                            if (confirmed) {
                              try {
                                await _dbService
                                    .UnarchiveAnnouncement(announcement['id']);
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                      content: Text(
