...
class ArchivedReportExcelExporter {
  ...
  Future<String> downloadReport() async {
    try {
      ...
      sheet.name = 'Archived_Citizensreports';
      ...
      final String name = 'Archived_CitizensReports_$formattedDate';
  ...
  Future<String> downloadReportByDate(
    ...
    try {
      ...
      final xlsio.Workbook workbook = xlsio.Workbook();
      final xlsio.Worksheet sheet = workbook.worksheets[0];
      sheet.name = 'Archived_Citizens_Reports';
