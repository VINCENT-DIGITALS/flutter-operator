...
class Archived_ExcelExporter {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  Future<String> downloadLogBook() async {
    try {
      ...
      final String name = 'Archived_LogBook_$formattedDate';
  ...
  Future<String> downloadLogBookByDate(
