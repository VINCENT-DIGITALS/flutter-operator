...
import 'Archived_logbook_download_excel_service.dart';

class Archived_DownloadDialog extends StatefulWidget {
  @override
  _Archived_DownloadDialogState createState() => _Archived_DownloadDialogState();
}

class _Archived_DownloadDialogState extends State<Archived_DownloadDialog> {
  final Archived_ExcelExporter excelExporter = Archived_ExcelExporter();
  ...
  Future<void> _downloadData() async {
    ...
    if (result == 'success') {
      await _showResultDialog('Download Successful',
          'The Archived logBook data has been downloaded successfully.');
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ListTile(
            title: Text('Download All Archived LogBook records'),
            subtitle: Text(''),
            leading: Radio<bool>(
              value: false,
