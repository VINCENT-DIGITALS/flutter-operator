...
class Archived_LogBookArchivingHelper {
  ...
  static Future<void> _unArchiveDocumentsInRange(
    ...
    try {
      ...
      Fluttertoast.showToast(
        msg: 'Log book records in the selected range have been Unarchived.',
        toastLength: Toast.LENGTH_LONG,
      );
    } catch (e) {
      Fluttertoast.showToast(
        msg: 'Error Unarchiving documents: $e',
        toastLength: Toast.LENGTH_LONG,
      );
    } finally {
      Navigator.of(mainContext).pop();
  ...
  static Future<void> _unArchiveAllDocuments(BuildContext mainContext) async {
    ...
    try {
      await batch.commit();
      Fluttertoast.showToast(
        msg: 'All log book records have been Unarchived.',
        toastLength: Toast.LENGTH_LONG,
      );
    } catch (e) {
      Fluttertoast.showToast(
  ...
  static Future<void> initialConfirmation(BuildContext mainContext) async {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Select UnArchiving Option'),
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Unarchive All', style: TextStyle(color: Colors.blue)),
          ),
          TextButton(
            onPressed: () {
              Navigator.of(context).pop();
            ...
            onPressed: () async {
              ...
              if (password.isNotEmpty) {
                try {
                  ...
                  if (archiveAll) {
                    await _unArchiveAllDocuments(mainContext);
                  } else if (startDate != null && endDate != null) {
                    await _unArchiveDocumentsInRange(mainContext, startDate, endDate);
                  }
                } catch (e) {
                  Fluttertoast.showToast(
